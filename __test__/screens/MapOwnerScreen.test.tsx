...
import MapOwnerScreen from '@/screens/MapOwnerScreen'; // adjust path if necessary
...
describe('MapOwnerScreen', () => {
    it('clubs appear on the map as markers', async () => {
        ...
        const { getByTestId } = render(<MapOwnerScreen />);
    ...
    it('error message appears if there are no clubs', async () => {
        ...
        const { getByText } = render(<MapOwnerScreen />);
    ...
    it('tapping on a marker shows the club details', async () => {
        ...
        const { getByTestId, getByText, getAllByText } = render(<MapOwnerScreen />);
    ...
    it('tapping on close button hides the club card', async () => {
        ...
        const { getByTestId, queryByText } = render(<MapOwnerScreen />);
